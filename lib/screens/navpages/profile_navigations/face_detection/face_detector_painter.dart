...
import 'package:flutter_application_2023/screens/navpages/profile_navigations/face_detection/coordinates_painter.dart';
...
class FaceDetectorPainter extends CustomPainter {
  ...
  void paint(final Canvas canvas, final Size size) {
    ...
    for (final Face face in faces) {
      ...
      //TODO: draw the blue circle for detected points on face
